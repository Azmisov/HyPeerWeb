 ...
 * @author isaac
 */
public class HyPeerWeb<T extends Node> extends Node implements HyPeerWebInterface{
	...
	private enum HyPeerWebState{
		...
		HAS_NONE {
			@Override
			public HyPeerWebState addNode(HyPeerWeb web){
			...
			@Override
			public HyPeerWebState removeNode(HyPeerWeb web){
		...
		public abstract HyPeerWebState addNode(HyPeerWeb web);
		public abstract HyPeerWebState removeNode(HyPeerWeb web);
	}
}
