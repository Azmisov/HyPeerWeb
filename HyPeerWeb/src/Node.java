 ...
 *
 * @author Guy
 * int and Integer need to be replaced with WebID and Height
...
public class Node {
     ...
     * @param sNeighbors An ArrayList containing the Surrogate Neighbors of 
     * the Node
     ...
     * @param al An ArrayList containing the new list of Neighbors.  If al
     * is null nothing will be changed
     */
     ...
     * @param al An ArrayList containing the new list of Surrogate Neighbors
     * If al is null nothing will be changed
     */
     ...
     * @return An ArrayList containing the Inverse Surrogate Neighbors of the Node
     */
